  ...
  return (
    <section className="bg-white py-12 px-6 lg:px-20">
      ...
      <p className="mt-3 text-gray-600 max-w-2xl">
        We offer comprehensive AI education programs designed to equip individuals with
        the skills to harness the power of artificial intelligence.
      </p>

      {/* View All Button */}
      <div className="mt-5">
        <Button className="bg-[#00725c] text-white font-semibold rounded-full px-6 py-2">
          View All Programs
        </Button>
      </div>
        ...
        <div className="bg-green-50 rounded-xl overflow-hidden  flex flex-col">
          ...
          <div className="p-6">
            ...
            <div className="mt-5 flex justify-between items-center">
              ...
              <Button className="bg-[#00725c] text-white rounded-full px-5 py-2">
                Join Now
              </Button>
            </div>
          </div>
